...
public class BillResultFrame extends javax.swing.JFrame {
    ...
    public BillResultFrame(Order orderId, Client clientId) {
        ...
        appLabel.setText(Integer.toString(orderId.getId()));
        patientIdLabel.setText(Integer.toString(clientId.getId()));

        try {
            String ordDate = this.orderId.getDate().toString();
            appDate.setText(ordDate);
            String first = this.clientId.getFirstName();
            String last = this.clientId.getLastName();
            String loc = this.clientId.getLocation();
            String docf = BillController.instance.getDoctorFirst(this.orderId.getId());
            String docl = BillController.instance.getDoctorLast(this.orderId.getId());
            ...
            model = BillController.instance.showAnalysis(orderId.getId());
